...
$$
\text{CAPEX}_{\text{init}} = \mathtt{hw\_setup\_cost\_fibre} + e \cdot L \cdot \mathtt{focl\_constr\_cost\_fibre}
$$
...
$$
\text{CAPEX}_{\text{reinv}} = \mathtt{hw\_setup\_cost\_fibre} \cdot \left\lfloor \frac{P}{\mathtt{reinv\_period\_fibre}} \right\rfloor
$$
...
$$
\text{OPEX}_{\text{annual}} = \mathtt{an\_hw\_maint\_and\_repl\_fibre} \cdot \text{CAPEX}_{\text{init}}
\qquad
...
$$
\text{Rev}_{\text{annual}} = \min\!\left(Q,\ \mathtt{max\_throughput\_fibre}\right) \cdot \mathtt{an\_isp\_fees\_one\_mbps\_fibre}
\qquad
...
Cellular is considered a feasible technology for a POI if it is within the cellular coverage area (4G or 5G).
...
$$
\text{CAPEX}_{\text{init}} = \mathtt{hw\_setup\_cost\_p2area}
$$

Hardware is replaced at regular intervals over the project period. The number of reinvestments is the number of complete reinvestment cycles elapsed:

$$
\text{CAPEX}_{\text{reinv}} = \text{CAPEX}_{\text{init}} \cdot \left\lfloor \frac{P}{\mathtt{reinv\_period\_p2area}} \right\rfloor
$$
...
$$
\text{OPEX}_{\text{annual}} = \mathtt{an\_hw\_maint\_and\_repl\_p2area} \cdot \text{CAPEX}_{\text{init}}
\qquad
\text{OPEX}_{\text{total}} = P \cdot \text{OPEX}_{\text{annual}}
$$
...
$$
\text{Rev}_{\text{annual}} = \min\!\left(Q,\ \mathtt{max\_throughput\_p2area}\right) \cdot \mathtt{an\_isp\_fees\_one\_mbps\_p2area}
\qquad
\text{Rev}_{\text{total}} = P \cdot \text{Rev}_{\text{annual}}
$$
...
| Parameter | Description | Default | Configurable in CPP |
|---|---|---|---|
| `hw_setup_cost_p2p` | Hardware setup cost, including access links and assuming one hop per POI (USD/POI) | 3,000 | Yes |
| `access_link_bandwidth_p2p` | Bandwidth per access link (MHz) | 40 | Yes |
...
$$
B = \mathtt{access\_link\_bandwidth\_p2p}
$$

This bandwidth drives both the one-time and recurring licence fees:

$$
F_{\text{licence}}^{\text{once}} = \mathtt{one\_time\_license\_fee\_1mhz\_p2p} \cdot B
\qquad
F_{\text{licence}}^{\text{annual}} = \mathtt{an\_license\_fee\_1mhz\_p2p} \cdot B
$$
...
$$
\text{CAPEX}_{\text{hw}} = \mathtt{hw\_setup\_cost\_p2p}
$$
...
$$
\text{CAPEX}_{\text{reinv}} = \text{CAPEX}_{\text{hw}} \cdot \left\lfloor \frac{P}{\mathtt{reinv\_period\_p2p}} \right\rfloor
$$
...
$$
\text{OPEX}_{\text{annual}} = F_{\text{licence}}^{\text{annual}} + \mathtt{an\_hw\_maint\_and\_repl\_p2p} \cdot \text{CAPEX}_{\text{hw}}
\qquad
\text{OPEX}_{\text{total}} = P \cdot \text{OPEX}_{\text{annual}}
$$
...
$$
\text{Rev}_{\text{annual}} = \min\!\left(Q,\ \mathtt{max\_throughput\_p2p}\right) \cdot \mathtt{an\_isp\_fees\_one\_mbps\_p2p}
\qquad
\text{Rev}_{\text{total}} = P \cdot \text{Rev}_{\text{annual}}
$$
...
$$
\text{CAPEX}_{\text{init}} = \mathtt{hw\_setup\_cost\_sat}
$$

Hardware is replaced at regular intervals over the project period. The number of reinvestments is the number of complete reinvestment cycles elapsed:

$$
\text{CAPEX}_{\text{reinv}} = \text{CAPEX}_{\text{init}} \cdot \left\lfloor \frac{P}{\mathtt{reinv\_period\_sat}} \right\rfloor
$$
...
$$
\text{OPEX}_{\text{annual}} = \mathtt{an\_hw\_maint\_and\_repl\_sat} \cdot \text{CAPEX}_{\text{init}}
\qquad
\text{OPEX}_{\text{total}} = P \cdot \text{OPEX}_{\text{annual}}
$$
...
$$
\text{Rev}_{\text{annual}} = \min\!\left(Q,\ \mathtt{max\_throughput\_sat}\right) \cdot \mathtt{an\_isp\_fees\_one\_mbps\_sat}
\qquad
\text{Rev}_{\text{total}} = P \cdot \text{Rev}_{\text{annual}}
$$
